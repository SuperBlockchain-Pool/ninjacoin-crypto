...
runTest('cn_fast_hash', () => NinjaCoinCrypto.cn_fast_hash('00000000'));

runTest('secretKeyToPublicKey',
    () => NinjaCoinCrypto.secretKeyToPublicKey(
...
runTest(
    ...
    () => NinjaCoinCrypto.generateKeyDerivation(
...
runTest('derivePublicKey',
    () => NinjaCoinCrypto.derivePublicKey(
...
runTest('underivePublicKey',
    () => NinjaCoinCrypto.underivePublicKey(
        '4827dbde0c0994c0979e2f9c046825bb4a065b6e35cabc0290ff5216af060c20',
        2,
...
runTest('deriveSecretKey',
    () => NinjaCoinCrypto.deriveSecretKey(
        '4827dbde0c0994c0979e2f9c046825bb4a065b6e35cabc0290ff5216af060c20',
        2,
...
runTest('generateKeyImage',
    () => NinjaCoinCrypto.generateKeyImage(
        'bb55bef919d1c9f74b5b52a8a6995a1dc4af4c0bb8824f5dc889012bc748173d',
